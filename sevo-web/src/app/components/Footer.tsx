...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="bg-[#f5f7fa] border-t border-navy/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
            <div>
              <span className="text-navy font-extrabold text-2xl tracking-widest block mb-3">SEVO</span>
              <p className="text-navy/50 text-sm max-w-xs leading-relaxed">
                Ihr zuverlässiger Dienstleistungspartner in Ulm und Umgebung.
              </p>
              <p className="text-navy/50 text-sm mt-3">📍 Ulm, Baden-Württemberg</p>
            ...
            <div className="flex flex-col gap-3 sm:items-end justify-center">
              <button
                ...
                className="text-navy/60 hover:text-gold transition-colors text-sm underline underline-offset-4 text-left sm:text-right"
              >
                Impressum
              </button>
              <button
