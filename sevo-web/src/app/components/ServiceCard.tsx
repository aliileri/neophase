...
const WA_BASE = 'https://wa.me/4915229003063?text='
...
export default function ServiceCard({ icon, title, description, whatsappText }: ServiceCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <a
        ...
        className="mt-1 bg-whatsapp text-white font-semibold px-4 py-3 rounded text-sm text-center hover:bg-whatsapp/90 transition-all duration-200 flex items-center justify-center gap-2 min-h-[48px]"
      >
        <WhatsAppIcon />
